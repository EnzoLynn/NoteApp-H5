...
(function ($, doc) {
   ...
   * 计算
   */
		caculateNinePointLotion: function caculateNinePointLotion(diffX, diffY) {
			var self = this;
			var Re = [];
   ...
   * 绘制
   */
		draw: function draw(cxt, _PointLocationArr, _LinePointArr, touchPoint) {
			var self = this;
			var R = self.R;
		...
		isPointSelect: function isPointSelect(touches, linePoint) {
			var self = this;
		...
		initEvent: function initEvent(canvas, cxt, holder) {
			var self = this;
			var linePoint = [];
