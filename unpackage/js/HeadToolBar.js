		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'a',
						{ className: 'mui-icon-pengyouquan mui-icon  mui-pull-left sharethis', onClick: me.openShareWindow },
						'分享'
					),
					React.createElement('a', { className: 'mui-icon mui-icon-plusempty mui-pull-right', onClick: me.openAddWindow }),
					React.createElement(
						'h1',
						{ className: 'mui-title' },
						'NoteApp '
