...
(function ($, window, document) {
	...
	var classSelector = function classSelector(name) {
   ...
   **/
		...
		caleLayout: function caleLayout() {
			var self = this;
		...
		scrollTo: function scrollTo(group) {
			var self = this;
		...
		bindBarEvent: function bindBarEvent() {
			var self = this;
			var pointElement = null;
			var findStart = function findStart(event) {
				if (pointElement) {
			...
			var findEnd = function findEnd(event) {
		...
		search: function search(keyword) {
			...
			self.hiddenGroups = [];
			var checkGroup = function checkGroup(currentIndex, last) {
		...
		bindSearchEvent: function bindSearchEvent() {
			var self = this;
